...
class DBConnection {
    ...
    public static function accountInformationProvider() {
    ...
    public static function saveTransaction($accNo, $updatedBalance) {
    ...
    public static function getCharge( $accNo, $type ) {
        $con = DBConnection::getInstance();
        $stmt = null;
    ...
    private static function serviceAuthentication( $accNo){
        $con = DBConnection::getInstance();
        $stmt = $con->prepare(
            "SELECT no as accNo, "
            . "name as accName, "
    ...
    private static function userAuthentication($accNo, $pin) {
        $con = DBConnection::getInstance();
